...
class ShopByCollectionPage extends StatelessWidget {
  const ShopByCollectionPage({super.key, required this.subCategory});
  ...
  Widget build(BuildContext context) {
    ...
    final products =
        subCategoryProvider.shopByCollectionMenCategory(subCategory.category);
    return Scaffold(
        appBar: AppBar(
